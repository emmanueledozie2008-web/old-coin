  ...
  return (
    <div>
      ...
      <div className="py-16 bg-gray-50 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-black mb-8">Featured Coins</h2>
        <div className="flex flex-wrap justify-center gap-8">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6 w-80 sm:w-96">
            ...
            <p className="text-lg text-gray-700 mb-4">A historic silver coin from the early 20th century. A collector's dream!</p>
            <Link to="/marketplace">
      ...
      <div className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white text-center">
        ...
        <div className="flex flex-wrap justify-center gap-12">
          <div className="w-64 sm:w-80">
            <h3 className="text-2xl font-semibold mb-3">Step 1: Choose Your Coin</h3>
            <p>Select from a variety of rare and collectible coins available on our marketplace.</p>
          </div>
          <div className="w-64 sm:w-80">
            <h3 className="text-2xl font-semibold mb-3">Step 2: Secure Payment</h3>
            <p>We ensure secure and simple payment methods for a smooth transaction.</p>
          </div>
          <div className="w-64 sm:w-80">
            <h3 className="text-2xl font-semibold mb-3">Step 3: Coin Grading</h3>
            <p>Get your coins graded and certified by our experienced professionals.</p>
          </div>
        </div>
        <Link to="/sell">
