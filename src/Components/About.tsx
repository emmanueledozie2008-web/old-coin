    ...
    <div>
      ...
      <div className="w-full bg-gray-50 flex flex-col items-center justify-center gap-12 pt-7 pb-12 px-4 sm:px-8">
        ...
        <div className="text-center w-full md:w-auto">
          <div className="pl-4">
            <img
              src={coin}
              className="h-[200px] w-auto mx-auto rounded-lg shadow-md"
            />
          </div>
          <div>
            <h3 className="text-black text-2xl sm:text-3xl font-semibold pt-4">
              Our Grading
            </h3>
        ...
        <div className="text-center w-full md:w-auto">
          <div className="pl-4 sm:pl-8">
            <img
              src={coin17}
              className="h-[200px] w-auto mx-auto bg-amber-500 rounded-lg shadow-md"
            />
          </div>
          <div>
            <h3 className="text-black text-2xl sm:text-3xl font-semibold pt-4">
            ...
            <p className="text-blue-700 text-center pt-3 text-base sm:text-lg px-4">
              NGC invested more than $1 million in research and development to
              create the most advanced protective holder for coins, tokens, and
              medals. Designed for long-term preservation, the NGC holder is
              used by the Smithsonian Institution and other museums around the
              world to protect their most treasured rarities.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-gradient-to-r from-blue-500 to-teal-500 py-8 px-4 sm:px-8">
        ...
        <p className="text-base sm:text-lg pt-4 text-center text-black">
          Collectors have greater confidence in NGC-certified coins because the
          coins are backed by the NGC Guarantee, the strongest in the industry.
          The NGC Guarantee provides one of several remedies in the rare event
          that an NGC-certified coin is determined to be not genuine or
          overgraded.
        </p>
      </div>
